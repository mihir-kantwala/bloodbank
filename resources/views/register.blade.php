...
<body class="bg-gradient-to-br from-red-100 via-white to-red-200 min-h-screen flex items-center justify-center font-sans">
    ...
    <div class="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md text-center">
        ...
        <!-- Registration Form -->
        <form action="{{ route('auth.register.submit') }}" method="POST" class="space-y-4 text-left">
            @csrf
        ...
        <div class="mt-6 text-sm text-gray-600">
            <p>Already have an account? <a href="{{ url('/login') }}" class="text-red-600 font-semibold hover:underline">Login</a></p>
